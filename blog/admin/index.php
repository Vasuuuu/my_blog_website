...
<?php endif ?>
    <div class="container dashboard__container">
        <button id="show__sidebar-btn" class="sidebar__toggle"><img src="<?=ROOT_URL?>icons/left-arrow.png"></button>
        <button id="hide__sidebar-btn" class="sidebar__toggle"><img src="<?=ROOT_URL?>icons/right-arrow.png"></button>
        <aside>
            <ul>
                <li><a href="add-post.php"><img src="../icons/edit.png"><h5>Add Post</h5></a></li>
                <li><a href="index.php" class="active"><img src="../icons/postcard.png"><h5>Manage Posts</h5></a></li>
        ...
        <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <!-- get category title ofeach post from categories table -->
                    <?php 
